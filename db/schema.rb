...
ActiveRecord::Schema.define(version: 2021_04_25_065322) do
  ...
  create_table "send_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_id"], name: "index_send_addresses_on_purchase_id"
  end
  ...
  add_foreign_key "send_addresses", "purchases"
end
